...
library CondsRepo {
    ...
    error CondsRepo_Overflow(bytes32 reason);
    ...
    function checkCond(
        ...
        else revert CondsRepo_Overflow(bytes32("CR_CompOprOverflow"));
    }
    ...
    function checkCondsOfTwo(
        ...
        else revert CondsRepo_Overflow(bytes32("CR_LogicOprOverflow"));
    }
