...
library WaterfallsRepo {
    ...
    function initClass(
        ...
        require(info.distrDate == 0, "WR.initClass: existing class");
        require(principal > 0, "WR.initClass: zero principal");
    ...
    function redeemClass(
        ...
        if (info.distrDate > 0) {
            ...
            require(principal > 0, "WR.redeemClass: zero principal");
            require(info.principal > principal, "WR.redeemClass: principal overflow");
