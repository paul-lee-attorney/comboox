...
contract ShareholdersAgreement is IShareholdersAgreement, SigPage {
    ...
    function initDefaultRules() external onlyDK {
        ...
        // DefaultVotingRules
        rules[1]  = bytes32(uint(0x00010c01000100001a0b000001000f0f0e010100000000000000000000000000));
        rules[2]  = bytes32(uint(0x00020c02000100001388000100010f0f0e010100000000000000000000000000));
        rules[3]  = bytes32(uint(0x00030c0300010000000000010100000000010100000000000000000000000000));
        rules[4]  = bytes32(uint(0x00040c04000100001a0b000001000f0f0e010100000000000000000000000000));
        rules[5]  = bytes32(uint(0x00050c05000100001388000100010f0f0e010100000000000000000000000000));
        rules[6]  = bytes32(uint(0x00060c06000100001a0b000001000f0f0e010100000000000000000000000000));
        rules[7]  = bytes32(uint(0x00070c07000100001a0b000001000f0f0e010100000000000000000000000000));
