...
contract ShareholdersAgreement is IShareholdersAgreement, SigPage {
    ...
    function initDefaultRules() external onlyDK {
        ...
        _rules.rules[0] = bytes32(uint(0x000001010003e800000d0503e8003213880500241388000000000000140105dc));
        // DefaultVotingRules
        _rules.rules[1]  = bytes32(uint(0x00010c01000100001a0b000001000f0f00010100000000000000000000000000));
        _rules.rules[2]  = bytes32(uint(0x00020c02000100001388000100010f0f00010100000000000000000000000000));
        _rules.rules[3]  = bytes32(uint(0x00030c0300010000000000010100000000010100000000000000000000000000));
        _rules.rules[4]  = bytes32(uint(0x00040c04000100001a0b000001000f0f00010100000000000000000000000000));
        _rules.rules[5]  = bytes32(uint(0x00050c05000100001388000100010f0f00010100000000000000000000000000));
        _rules.rules[6]  = bytes32(uint(0x00060c06000100001a0b000001000f0f00010100000000000000000000000000));
        _rules.rules[7]  = bytes32(uint(0x00070c07000100001a0b000001000f0f00010100000000000000000000000000));
        _rules.rules[8]  = bytes32(uint(0x00080c08000100001a0b00000100000000010100000000000000000000000000));
        _rules.rules[9]  = bytes32(uint(0x00090c0900010000138801000000000000010100000000000000000000000000));
        _rules.rules[10] = bytes32(uint(0x000a0c0a000100001a0b01000000000000010100000000000000000000000000));
        _rules.rules[11] = bytes32(uint(0x000b0c0b00021388000001000000000009010100000000000000000000000000));
        _rules.rules[12] = bytes32(uint(0x000c0c0c00021a0b000001000000000009010100000000000000000000000000));
        // DefaultFirstRefusalRules
        _rules.rules[512] = bytes32(uint(0x0200020101010100000000000000000000000000000000000000000000000000));
        _rules.rules[513] = bytes32(uint(0x0201020202010100000000000000000000000000000000000000000000000000));
