...
import "./IGeneralKeeper_5.sol";

contract GeneralKeeper_5 is IGeneralKeeper_5, RoyaltyCharge {
    ...
    function regInvestor(uint groupRep, bytes32 idHash) external{
        ILOOKeeper_3(_keepers[10]).regInvestor(msg.sender, groupRep, idHash);
    }

    function approveInvestor(uint userNo, uint seqOfLR) external{
        ILOOKeeper_3(_keepers[10]).approveInvestor(userNo, msg.sender,seqOfLR);        
    }

    function revokeInvestor(uint userNo, uint seqOfLR) external{
        ILOOKeeper_3(_keepers[10]).revokeInvestor(userNo, msg.sender,seqOfLR);        
    }
    ...
    function placeInitialOffer(
        ...
        ILOOKeeper_3(_keepers[10]).placeInitialOffer(
            msg.sender,
            classOfShare,
            execHours,
            paid,
    ...
    function withdrawInitialOffer(
        ...
        ILOOKeeper_3(_keepers[10]).withdrawInitialOffer(
            msg.sender,
            classOfShare,
            seqOfOrder,
            seqOfLR
    ...
    function placeSellOrder(
        ...
        ILOOKeeper_3(_keepers[10]).placeSellOrder(
            msg.sender,
            seqOfClass,
            execHours,
            paid,
    ...
    function withdrawSellOrder(
        ...
        ILOOKeeper_3(_keepers[10]).withdrawSellOrder(
            msg.sender,
            classOfShare,
            seqOfOrder
        );        
    ...
    function placeBuyOrder(uint classOfShare, uint paid, uint price, uint execHours) external payable{
        ILOOKeeper_3(_keepers[10]).placeBuyOrder(
            msg.sender,
            classOfShare,
            paid,
            price,
    ...
    function withdrawBuyOrder(
        ...
        ILOOKeeper_3(_keepers[10]).withdrawBuyOrder(
            msg.sender,
            classOfShare,
            seqOfOrder
        );        
    ...
    function getLOO() external view returns (IListOfOrders_2) {
        return IListOfOrders_2(_books[10]);
    }
