...
async function main() {
    ...
    expect(res.navPrice).to.equal(2.5 * 10 ** 4);
    ...
    res = formatUnits((await ror.getInfoOfPack(3, big2Num(list[list.length - 1]))).value.toString(), 4);
    expect(res).to.equal('250.0');
