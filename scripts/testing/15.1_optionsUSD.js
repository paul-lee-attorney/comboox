...
const { getGK, getROS, getROO, getRC, getROM, getCashier, getUsdROOKeeper, getUsdKeeper, } = require("./boox");
...
async function main() {
    ...
    tx = await usdKeeper.connect(signers[1]).payOffSwap(auth, 2, 1, signers[3].address);
