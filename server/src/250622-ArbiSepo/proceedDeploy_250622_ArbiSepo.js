...
const { 
	RegCenter, EnumerableSet, GoldChain, InvestorsRepo,
	RulesParser
} = require("../250619-ArbiSepo/contracts-address-consolidated.json");
...
async function main() {
	...
	const libUsdOrdersRepo = await readContract("UsdOrdersRepo", "0x0Df177ceAB38fEe802A6A1df7b100Fe76113C202");	
