...
const { 
	RegCenter, Checkpoints, CondsRepo, EnumerableSet, 
	LockersRepo, SharesRepo, DocsRepo, RulesParser,
	ArrayUtils, RolesRepo, SigsRepo, MembersRepo,
	TopChain, InvestorsRepo,
} = require("../241224-Arbi/contracts-address-consolidated.json")
...
async function main() {
	...
	let usdc = "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"; // Arbi
	...
	let rc = await readContract("RegCenter", RegCenter);
