...
async function main() {
	...
	console.log("take back key of orgUsdLooKeeper back to signers[1]. \n");

	orgKeeper.connect(signers[1]).takeBackKeys(orgBookAddr);
	console.log("take back key of orgLOO back to signers[1]. \n");

	orgBook.connect(signers[1]).setDirectKeeper(usdLooKeeper.address);
	console.log("set DK of orgUsdLOO to usdLooKeeper. \n");
	orgKeeper.connect(signers[1]).setDirectKeeper(usdKeeper.address);
	console.log("set DK of orgUsdLOOKeeper to usdLooKeeper. \n");
