...
const { addrs } = require("./addrs_240625_ArbiSepo");
...
async function main() {
	...
	// let rc = await readContract("RegCenter_2", "0xe1265060D1AB668716F4edf73E85340194F5e8af");
	...
	// let pc = await readContract("PriceConsumer_3", "0xFC85Faf737d8290DEd651d06034B22D16dA0F826");
	...
	await rc.connect(signers[1]).setTemplate( 20, addrs.GeneralKeeper_3, 1);
	console.log("set template for GK_3 at address: ", addrs.GeneralKeeper_3, "\n");
