...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface AddressInterface extends Interface {
    getFunction(nameOrSignature: "toString"): FunctionFragment;

    

    encodeFunctionData(functionFragment: 'toString', values: [AddressLike]): string;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getFunction(nameOrSignature: 'toString'): TypedContractMethod<
      [account: AddressLike, ],
      [string],
      'view'
    >;
