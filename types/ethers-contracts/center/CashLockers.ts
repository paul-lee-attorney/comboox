...
export declare namespace ICashLockers {
  ...
  export interface CashLockersInterface extends Interface {
    getFunction(nameOrSignature: "counterOfLockers" | "custodyOf" | "getHeadOfLocker" | "getLocker" | "getLockersList" | "isLocked" | "lockConsideration" | "lockUsd" | "totalCustody" | "unlockUsd" | "usdc" | "withdrawUsd"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'withdrawUsd', data: BytesLike): Result;
  ...
  export interface CashLockers extends BaseContract {
    
    connect(runner?: ContractRunner | null): CashLockers;
    waitForDeployment(): Promise<this>;

    interface: CashLockersInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    lockConsideration: TypedContractMethod<
      [auth: ICashLockers.TransferAuthStruct, to: AddressLike, expireDate: BigNumberish, target: AddressLike, payload: BytesLike, hashLock: BytesLike, ],
      [void],
      'nonpayable'
    >
