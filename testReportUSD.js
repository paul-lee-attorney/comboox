...
(async () => {
  try {
    ...
    await runScript('npx', ['hardhat', 'run', './scripts/testing/08.1_capitalIncreaseUSD.js', '--network', 'localhost']);
    await runScript('npx', ['hardhat', 'run', './scripts/testing/09_externalTransfer.js', '--network', 'localhost']);
    await runScript('npx', ['hardhat', 'run', './scripts/testing/10.1_internalTransferUSD.js', '--network', 'localhost']);
    await runScript('npx', ['hardhat', 'run', './scripts/testing/11_antiDilution.js', '--network', 'localhost']);
    await runScript('npx', ['hardhat', 'run', './scripts/testing/12.1_alongsUSD.js', '--network', 'localhost']);
